...
<button style="margin-top:10px;margin-left:15px;background-color:#80ced6"><a href="#">ADD</a></button>
<div class="col-md-12">  
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <table style="width: 100%;">
                ...
                <tbody>
                    <?php
                        $stmt = $conn->prepare("select tbl_material.TenNL as 'TenNL',tbl_recipe.SoLuong as 'SoLuong'
